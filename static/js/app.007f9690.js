        ...
        var l = function() {
            ...
            u = function() {
                var e = this,
                    t = e.$createElement,
                    n = e._self._c || t;
                return n("el-container", [n("el-header", [e._v("")]), n("el-main", [n("el-row", {
                    attrs: {
                        type: "flex",
                        justify: "center"
                    }
                ...
                }, [n("el-divider", [n("h1", [e._v("小小清单")])]), n("TodoList")], 1)])], 1)], 1), n("el-footer", [e._v("技术栈：GoLang + Gin + Gorm + MySQL")])], 1)
            },
            d = [],
            f = function() {
                var e = this,
                    ...
                    scopedSlots: e._u([{
                        ...
                        fn: function(t) {
                            return [n("el-button", {
                                ...
                                attrs: {
                                    type: "info",
                                    icon: t.row.favorite ? "el-icon-star-on" : "el-icon-star-off",
                                    circle: ""
                                },
                                on: {
                                    click: function(n) {
                                        return e.handleFavorite(t.$index, t.row)
                                    }
                                }
                            })]
                        }
            ...
            h = {
                ...
                methods: {
                    ...
                    // 收藏/取消收藏
                    handleFavorite: function(index, row) {
                        var self = this;
                        var newFavoriteState = !row.favorite; // 切换收藏状态
                        this.axios.put("/v1/todo/favorite/" + row.id, {
                            favorite: newFavoriteState
                        }).then(function() {
                            self.tableData[index].favorite = newFavoriteState;
                            var msg = newFavoriteState ? "收藏成功" : "取消收藏成功";
                            self.$message({
                                showClose: true,
                                duration: 1500,
                                message: msg,
                    ...
                    // 修改待办分类
                    handleCategoryChange: function(row, value) {
                        var self = this;
